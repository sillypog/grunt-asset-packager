...
exports.asset_packager = {
	...
	dev: function (test) {
		...
		var jsFilesExist = grunt.file.exists('tmp/dev/js/file1.js') && grunt.file.exists('tmp/dev/js/file2.js');
	...
	prod: function (test) {
		...
		test.ok(grunt.file.exists('tmp/prod/js/common.js'), 'should create packaged js file');
		test.ok(grunt.file.exists('tmp/prod/css/common.css'), 'should create packaged css file');

		var actualJSLines = grunt.file.read('tmp/prod/js/common.js').split(grunt.util.linefeed),
		    expectedJSLines = grunt.file.read('test/expected/prod/js/common.js').split(grunt.util.linefeed);
		...
		var actualCSSLines = grunt.file.read('tmp/prod/css/common.css').split(grunt.util.linefeed),
		    expectedCSSLines = grunt.file.read('test/expected/prod/css/common.css').split(grunt.util.linefeed);
		...
		test.ok(grunt.file.exists('tmp/prod/js/concatenated.js'));
