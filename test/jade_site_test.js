...
exports.asset_packager = {
	...
	dev: function (test) {
		...
		test.ok(grunt.file.exists('tmp/jade/dev/app/views/includes/module1.html'), 'should generate include from subdirectory');
		test.equal(grunt.file.read('tmp/jade/dev/app/views/includes/module1.html'), grunt.file.read('test/expected/jade/dev/app/views/includes/module1.html'), 'should correctly format main.html');

		test.ok(grunt.file.exists('tmp/jade/dev/public/js/file1.js'), 'should copy js/file1.js');
		test.ok(grunt.file.exists('tmp/jade/dev/public/js/file2.js'), 'should copy js/file2.js');
		test.ok(grunt.file.exists('tmp/jade/dev/public/js/module1/file1.js'), 'should copy module1/file1.js');
		test.ok(grunt.file.exists('tmp/jade/dev/public/js/module1/file2.js'), 'should copy module1/file2.js');
	...
	prod: function (test) {
		...
		test.ok(grunt.file.exists('tmp/jade/prod/public/js/module1.js'), 'should create packaged js file');
